...
const PreviousJobsTable = ({ previousJobs, height, width }: PreviousJobsTableProps) => {
...
const PreviousJobs = () => {
  ...
  const handleAddPreviousJobDetails = useCallback((data: PreviousJobType) => {
    setPreviousJobs(prevState => [
      ...prevState,
      data
    ]);
    handleDialogClose();
